...
% This document depends on fundamental-concepts.tex.tex, which provides
...
\begin{remark}{Equality of sets}{intro-equal-sets}
  ...
  This book proves many characterization theorems for classes of graphs. Such a theorem states that two sets are the same (e.g., the set of bipartite graphs is equal to the set of graphs without odd cycles---Theorem 1.2.18 in text). % TODO: link to Theorem 1.2.18
\end{remark}
