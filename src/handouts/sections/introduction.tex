...
Note that the subnet of $S \times T$ can be (1) an empty set, (2) one or some of pairs in $S \times T$, or (3) the entire $S \times T$. See \cref{def:intro-set-equal} and its notes in \cpageref{def:intro-set-equal} for more info.
